...
@section('content')
    ...
    <!-- Preview Image -->
    <img class="img-responsive" src="{{$post->photo ? $post->photo->file : "https://via.placeholder.com/900x300.png"}}" alt="">
    ...
    @if(Session::has('comment_message'))
        ...
        <div style="background: #ffe924 ">{{session('comment_message')}}</div>
    ...
    @if(Auth::check()) <!--This means only if the user is logged in he can comment -->
